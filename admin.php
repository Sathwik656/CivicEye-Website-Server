...
<div class="mobile-nav-menu" id="mobileNavMenu" aria-hidden="true">
    ...
    <a href="admin_review.php">Admin Review</a>
    <a href="user_page.php">User Dashboard</a>
    ...
    <div class="admin-container">
        ...
        <section class="stats-section" data-aos="fade-up">
            <div class="stats-numbers">
                <div class="stat-item total" data-stat="total"> <span class="stat-value">0</span><span class="stat-label">Total Detections</span></div>
                <div class="stat-item pending" data-stat="pending"> <span class="stat-value">0</span><span class="stat-label">Pending Review</span></div>
                <div class="stat-item approved" data-stat="approved"> <span class="stat-value">0</span><span class="stat-label">Approved Violations</span></div>
                <div class="stat-item rejected" data-stat="rejected"> <span class="stat-value">0</span><span class="stat-label">Rejected / False</span></div>
            </div>
        </section>
        ...
        <div class="violations-grid" id="violationsGrid" data-aos="fade-up" data-aos-delay="200">
            <div class="violation-card" data-status="pending" data-id="v001">
                <img class="violation-image" src="https://placehold.co/400x220/111827/A855F7?text=Violation+Image+1" alt="Violation Screenshot 1" onerror="this.style.backgroundColor='#333'; this.alt='Image load error'; this.src='https://placehold.co/400x220/333333/cccccc?text=Error';">
                <div class="violation-details">
                    <h4>Violation: No Helmet</h4>
                    <p><strong>Date:</strong> 2025-04-21</p><p><strong>Time:</strong> 14:32:15</p>
            ...
            <div class="violation-card" data-status="pending" data-id="v002">
                <img class="violation-image" src="https://placehold.co/400x220/111827/FF6600?text=Violation+Image+2" alt="Violation Screenshot 2" onerror="this.style.backgroundColor='#333'; this.alt='Image load error'; this.src='https://placehold.co/400x220/333333/cccccc?text=Error';">
                <div class="violation-details">
                    <h4>Violation: No Helmet</h4>
                    <p><strong>Date:</strong> 2025-04-21</p><p><strong>Time:</strong> 11:05:48</p>
            ...
            <div class="violation-card" data-status="approved" data-id="v003">
                <img class="violation-image" src="https://placehold.co/400x220/111827/7BD3EA?text=Violation+Image+3" alt="Violation Screenshot 3" onerror="this.style.backgroundColor='#333'; this.alt='Image load error'; this.src='https://placehold.co/400x220/333333/cccccc?text=Error';">
                <div class="violation-details">
                    <h4>Violation: No Helmet</h4>
                    <p><strong>Date:</strong> 2025-04-20</p><p><strong>Time:</strong> 18:15:30</p>
                    <p><strong>Location:</strong> Cam 01 - Main St.</p>
             ...
             <div class="violation-card" data-status="rejected" data-id="v004">
                <img class="violation-image" src="https://placehold.co/400x220/111827/A855F7?text=Violation+Image+4" alt="Violation Screenshot 4" onerror="this.style.backgroundColor='#333'; this.alt='Image load error'; this.src='https://placehold.co/400x220/333333/cccccc?text=Error';">
                <div class="violation-details">
                    <h4>Violation: No Helmet</h4>
                    <p><strong>Date:</strong> 2025-04-20</p><p><strong>Time:</strong> 09:55:11</p>
             ...
             <div class="violation-card" data-status="pending" data-id="v005">
                <img class="violation-image" src="https://placehold.co/400x220/111827/FF6600?text=Violation+Image+5" alt="Violation Screenshot 5" onerror="this.style.backgroundColor='#333'; this.alt='Image load error'; this.src='https://placehold.co/400x220/333333/cccccc?text=Error';">
                <div class="violation-details">
                    <h4>Violation: No Helmet</h4>
                    <p><strong>Date:</strong> 2025-04-19</p><p><strong>Time:</strong> 12:01:01</p>
...
<footer>
    <div class="footer-container">
        <div class="footer-top">
            <div class="footer-logo"><img src="IMAGES/logo1.png" alt="Civic Eye Logo" onerror="this.onerror=null; this.src='https://placehold.co/150x40/111111/FFFFFF?text=CivicEye';" /></div>
            <div class="footer-description">Civic Eye: AI-powered traffic violation monitoring using existing CCTV, prioritizing local processing and privacy.</div>
        ...
        <div class="footer-links-section">
            <div class="footer-links-column"><h3>Quick Links</h3><nav><a href="index.php">Home</a><a href="download.php">Download</a><a href="team.php">Team</a><a href="contact-us.php">Contact Us</a></nav></div>
            <div class="footer-links-column"><h3>Resources</h3><nav><a href="index.php#features">Features</a><a href="download.php#requirements">Requirements</a><a href="#">Documentation</a></nav></div>
            <div class="footer-links-column"><h3>Contact Info</h3><p>Mangaluru, Karnataka 575001, India.</p><p>+91 XXXXX-XXXXX</p><p>info@civiceye.example.com</p></div>
            <div class="footer-links-column"><h3>Legal</h3><nav><a href="#">Privacy Policy</a><a href="#">Terms & Conditions</a></nav></div>
        </div>
        <div class="footer-bottom"><div>&copy; 2025 Civic Eye. All rights reserved.</div><div class="footer-bottom-links"><a href="#">Privacy</a><a href="#">Terms</a><a href="#">Sitemap</a></div></div>
    </div>
</footer>
...
<script>
    document.addEventListener("DOMContentLoaded", () => {
        ...
        const toggleNav = (event) => { if (event) event.stopPropagation(); if(mobileNav && body && hamburgerBtn) { const isActive = mobileNav.classList.toggle('active'); body.classList.toggle('modal-open', isActive); /* Use modal-open class */ hamburgerBtn.setAttribute('aria-expanded', isActive); mobileNav.setAttribute('aria-hidden', !isActive); } else { console.error("Mobile navigation elements not found."); } };
        const closeNav = () => { if (mobileNav && mobileNav.classList.contains('active') && body && hamburgerBtn) { mobileNav.classList.remove('active'); body.classList.remove('modal-open'); hamburgerBtn.setAttribute('aria-expanded', 'false'); mobileNav.setAttribute('aria-hidden', 'true'); } };
        if (hamburgerBtn && mobileNav && closeNavBtn) { hamburgerBtn.addEventListener('click', toggleNav); closeNavBtn.addEventListener('click', closeNav); navLinks.forEach(link => { link.addEventListener('click', () => { setTimeout(closeNav, 150); }); }); const logoutLink = mobileNav.querySelector('a.logout-btn-link'); if (logoutLink) { logoutLink.addEventListener('click', () => { setTimeout(closeNav, 150); }); } document.addEventListener('click', (event) => { if (mobileNav.classList.contains('active') && !mobileNav.contains(event.target) && !hamburgerBtn.contains(event.target)) { closeNav(); } }); mobileNav.addEventListener('click', (event) => { event.stopPropagation(); }); document.addEventListener('keydown', (event) => { if (event.key === 'Escape' && mobileNav.classList.contains('active')) { closeNav(); } }); } else { console.error("Could not attach mobile navigation event listeners."); }
         ...
         // Function to update stat counts
         const updateStats = () => {
             const allCards = violationsGrid.querySelectorAll('.violation-card');
             const counts = { total: 0, pending: 0, approved: 0, rejected: 0 };
             allCards.forEach(card => { const status = card.dataset.status; if (status && counts.hasOwnProperty(status)) { counts[status]++; } counts.total++; });
             for (const status in counts) { if (statElements[status]) { statElements[status].textContent = counts[status]; } }
         };

         // Function to handle approve/reject clicks
         const handleViolationAction = (event) => {
             const button = event.target.closest('button');
             if (!button || (!button.classList.contains('btn-approve') && !button.classList.contains('btn-reject'))) return;
             ...
             if (!card || !statusElement || currentStatus !== 'pending') return;

             let newStatus = button.classList.contains('btn-approve') ? 'approved' : 'rejected';
             let newStatusClass = `status-${newStatus}`;
             ...
             setTimeout(() => { card.style.borderColor = (newStatus === 'approved') ? 'rgba(77, 182, 172, 0.5)' : 'rgba(239, 83, 80, 0.5)'; }, 1500);
         ...
         const handleFilter = (event) => {
            ...
            allCards.forEach(card => { const cardStatus = card.dataset.status; card.classList.toggle('hidden', !(filterValue === 'all' || cardStatus === filterValue)); });
         };

         // ** NEW ** Function to open image modal
         const openImageModal = (event) => {
             // Check if the click target is an image inside a violation card
             if (event.target.tagName === 'IMG' && event.target.classList.contains('violation-image')) {
                 modal.style.display = "block";
                 modalImg.src = event.target.src;
                 modalImg.alt = event.target.alt; // Copy alt text
         ...
         if (violationsGrid) {
            ...
            // ** NEW ** Add event listener for image clicks (delegated)
            violationsGrid.addEventListener('click', openImageModal);
            // Initial stat calculation
            updateStats();
         } else { console.error("Violations grid not found."); }
